//Reference and credits for this cache: https://github.com/xenova/transformers.js/blob/main/examples/extension/src/cache.js
...
class CustomCache implements CustomCache {
    /**
